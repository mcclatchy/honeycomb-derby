  ...
  $.fn.turntable = function(options){
    ...
    (function appendImages(callback) {
      $listItems.each(function () {
        ...
        var src1500 = 'http://media.mcclatchydc.com/static/graphics/050317-derby360/' + $(this).data('imgSrc') + ' 1500w, ';
        var src600 = 'http://media.mcclatchydc.com/static/graphics/050317-derby360/' + rmPeriod[0] + '-600.jpg 600w';

        // console.log($(this).data('imgSrc'));
        $(this).html('<img src="' + 'http://media.mcclatchydc.com/static/graphics/050317-derby360/'+ $(this).data("imgSrc") + '">');
        // $(this).html('<img src="' + 'http://media.mcclatchydc.com/static/graphics/050317-derby360/'+ $(this).data("imgSrc") + '" srcset="' + src1500 + src600 + '">');
